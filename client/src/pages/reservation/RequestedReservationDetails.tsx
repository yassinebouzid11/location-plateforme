...
export default function RequestedReservationDetails() {
  const { id } = useParams()
  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      ...
      <div className="flex justify-end gap-4 mr-3">
        <Button className="cursor-pointer" onClick={() => navigate(location.pathname===`/reservation/recived-request-details/${id}`?"/reservation/receved":"/reservation/requested")}>Annuler</Button>
      </div>
    </div>
  )
}
